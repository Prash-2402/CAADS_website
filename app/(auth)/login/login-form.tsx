...
export function LoginForm() {
  ...
  const roleValue = roleParam === "leader" ? "leader" : roleParam === "volunteer" ? "volunteer" : "student";
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <p className="font-body text-sm text-muted">
        Signing in as {roleValue === "leader" ? "a leader" : roleValue === "volunteer" ? "a volunteer" : "a student"}.
      </p>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          autoComplete="email"
          required
          placeholder="xy.z@btech.christuniversity.in"
          className="
