...
// Renamed from "highlights" — same stat-card content, updated id and heading.
export function Achievements() {
  const { highlights } = marketingData;

  return (
    <section id="achievements" className="py-24 bg-bg border-y border-border-gold/30">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="font-display text-4xl font-bold text-ivory mb-4">
            Achievements
          </h2>
          <div className="w-16 h-px bg-gold mx-auto rounded-full" />
        </div>
